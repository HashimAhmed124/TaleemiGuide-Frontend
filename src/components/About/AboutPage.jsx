    ...
    <div className="w-full text-[#14223C]">
      ...
      <div className="relative w-full h-[60vh] md:h-[75vh]">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-20">
          ...
          >
            Helping students choose the right career with confidence and clarity.
          </motion.p>
        </div>
      </div>
        ...
        <div className="w-full flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 w-full ml-20">
            <img
              src="/bg-2.jpg"
              alt="professor"
              className="w-180 h-full object-cover"
            />
          </div>
          ...
          <div className="md:w-1/2 w-full relative overflow-hidden">
            ...
            <div
              className="absolute inset-0 bg-cover bg-center mr-20"
              style={{
            ...
            {/* DARK OVERLAY */}
            <div className="absolute inset-0 bg-[#0A1A3A]/70 mr-11.5"></div>
            ...
            <div className="relative p-10 md:p-16 text-white">
              ...
              <button className="mt-8 bg-green-500 text-white px-6 py-3 rounded-md font-semibold hover:bg-green-600 transition">
                Apply Now
              </button>
            </div>
