    ...
    <section className="relative bg-gradient-to-br from-blue-50 via-white to-white">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 text-center">
        ...
        <p className="text-xm text-justify text-gray-600 max-w-3xl mx-auto mb-10">
          After completing Class 12, students reach one of the most important
          decision points of their academic and professional lives — choosing
          the right pathway, specialization, and institution for their next
          stage. Class 12 students in Pakistan now have multiple structured
          pathways, including professional and academic degrees, accounting and
          finance tracks, Associate Degree programs, technical/vocational
          skills, entrepreneurship routes, and direct entry into uniformed
          services routes. Research shows that most students are aware of only
          7–10% of actual career possibilities, leading to limited or
          misinformed choices. With hundreds of degree options, dozens of
          professional pathways, and an increasing demand for both digital and
          technical skills, Class 12 students today need clear, structured, and
          personalized guidance to choose the pathway that fits their goals.
        </p>
    ...
    <div className="max-w-6xl mx-auto px-6">
      <div className="grid md:grid-cols-2 gap-10">
        {[
          ...
          >
            <h2 className="text-2xl font-bold text-[#11253e]">{item.title}</h2>
            <div
...
const TakingRightDecisionSection = ({ onSeekAdviceClick }) => (
  <section
    className="relative py-12 bg-center max-w-6xl rounded-xl my-8 bg-cover bg-no-repeat "
      ...
      >
        ...
        <div className="relative max-w-4xl">
          ...
          <p
            ...
            style={{ color: COLORS.textGray }}
          >
            Once you have shortlisted possible fields after Class 12, the next
            step is to understand which career paths match your personality,
          ...
          <p
            ...
            style={{ color: COLORS.textGray }}
          >
            This leads to the <strong>Career Assessment Test</strong>, where you can discover
            your personality type and identify careers that best fit you. The
            assessment helps you make informed decisions before selecting your
            degree program or university.
          </p>
