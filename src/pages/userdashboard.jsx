          ...
          {nav.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full rounded-2xl px-4 py-3 text-left transition flex items-center justify-between ${isActive ? "shadow-sm" : "hover:bg-slate-50"
                  }`}
                style={{
                  backgroundColor: isActive
                    ? COLORS.lightBackground
                    : "transparent",
                  border: `1px solid ${isActive ? COLORS.softBorder : "transparent"
                    }`,
                }}
              >
                <div className="flex items-center gap-3">
